// Sample order data
const orders = [
    { id: 1, customer: "Yashwantkumar", status: "Pending", items: ["Laptop", "Phone"] },
    { id: 2, customer: "Jeevankumar", status: "Shipped", items: ["Tablet", "Headphones"] },
    { id: 3, customer: "Somashekar", status: "Delivered", items: ["Camera", "Tripod"] },
  ];
